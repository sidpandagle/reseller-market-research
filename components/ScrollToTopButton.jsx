...
const ScrollToTopButton = () => {
    ...
    return (
        <button onClick={scrollToTop} className='fixed z-50 flex items-center justify-center rounded-full bg-o2 hover:bg-o1 bottom-10 right-10' style={{ display: visible ? 'inline' : 'none' }}>
