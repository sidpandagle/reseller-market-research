...
const ScrollToTopButton = () => {
    ...
    return (
        <button onClick={scrollToTop} className='fixed z-50 flex items-center justify-center rounded-full bg-[#6366F1] bottom-10 right-10' style={{ display: visible ? 'inline' : 'none' }}>
