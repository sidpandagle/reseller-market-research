  ...
  return (
    <div>
      <div className={`${(segment !== 'request-sample' && segment !== 'Request') && 'md:sticky top-0'} p-4 relative justify-between gap-2 bg-white md:flex`}>
        ...
        <Link href={'/report/' + report?.url + '/highlights'} className={`md:w-1/4 py-3 md:mb-0 mb-4 duration-200 text-sm flex justify-center items-center border rounded-sm cursor-pointer  ${segment === 'highlights' ? 'font-bold bg-o1 text-white' : ''}`}>List of Tables and Figures</Link>
