...
export async function generateMetadata({ params, searchParams }, parent) {
    ...
    if (segment) {
        ...
        } else if (segment == 'request-sample') {
            section = 'Request Sample - ';
        } else {
            section = toCapitalCase(segment) + ' - ';
        }
    }
    ...
    return {
        ...
        keywords: [...report.data.meta_keyword.split(','), segment],
        alternates: {
            canonical: `${siteURL}/report/${url}/${segment}`,
        },
    }
}
                            ...
                            <div className='p-4 font-semibold text-black bg-tertiary'>
                                {
                                    ...
                                    <div>
                                        ...
                                        <div className={`mb-2 text-justify ${segment=='request-sample' && 'line-clamp-2'}`}>{report.title}</div>
